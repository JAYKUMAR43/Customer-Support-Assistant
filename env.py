...
from models import Observation, Action, Reward, State, StepResponse
...
class EcommerceEnv:
    ...
    def reset(self) -> Observation:
        obs = self.task.get_random_scenario()
    ...
    def step(self, action: Action) -> StepResponse:
        ...
        reward_val, reason = Grader.evaluate(self.current_state.observation, action)
        ...
        self.current_state.info = {"reason": reason}
